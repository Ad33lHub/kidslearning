    ...
    Future<bool> showExitPopup() async {
      return await showDialog(
        ...
        builder: (context) => AlertDialog(
          title: const Text('Exit App',style: TextStyle(color: Colors.black,fontSize: 30),),
          content: const Text('Do you want to exit an App?',style: TextStyle(color: Colors.black,fontSize: 20),),
          actions:[
             ElevatedButton(
                               ...
                               physics: const NeverScrollableScrollPhysics(),
                                 ...
                                 InkWell(
                                   ...
                                   child: Container(
                                     ...
                                     child: Column(
                                       ...
                                       children: [
                                         ...
                                         const Text('Lets Start Learning',style: TextStyle(fontFamily: "arlrdbd",color: Color(0xFF6DB072)),),
                                       ],
                                     ),
                                   ),
                                 ),
                                   InkWell(
                                     onTap: (){
                                       admobHelper.showInterad();
                                       Navigator.push(context,MaterialPageRoute(builder: (context)=>const VideoLearning()));
                                     },
                                     child: Container(
                                       decoration: BoxDecoration(
                                       ...
                                       child: Column(
                                         ...
                                         children: [
                                           ...
                                           const Text('Video Learning',style: TextStyle(fontFamily: "arlrdbd",color: Color(0xFFEC9E4E)),),
                                         ],
                                       ),
                                     ),
                                   ),
                                     ...
                                     child: Container(
                                       ...
                                       child: Column(
                                         ...
                                         children: [
                                           ...
                                           const Text('Look And Choose',style: TextStyle(fontFamily: "arlrdbd",color: Color(0xFFF2CC2B)),),
                                         ],
                                       ),
                                     ),
                                   ),
                                   InkWell(
                                     onTap: (){
                                       admobHelper.showInterad();
                                       Navigator.push(context,MaterialPageRoute(builder: (context)=>const ListenGuess()));
                                     },
                                     child: Container(
                                       decoration: BoxDecoration(
                                       ...
                                       child: Column(
                                         ...
                                         children: [
                                           ...
                                           const Text('Listen and Guess',style: TextStyle(fontFamily: "arlrdbd",color: Color(0xFF8770E4)),),
                                         ],
                                       ),
                                     ),
                                   ),
