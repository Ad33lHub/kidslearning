  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Center(child: Text('ABC Video Songs',style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),)),
        ),
        body: Container(
                  ...
                  child: Card(
                    color: const Color(0xFFEBE8FD),
                      ...
                      Padding(
                        ...
                        child: Center(child: Text(alphabetvideolist[index].Text,style: const TextStyle(color: Color(0xFF000000),fontFamily: "arlrdbd",fontSize: 15),)),
                          )
                        ]
                      ),
                  ),
