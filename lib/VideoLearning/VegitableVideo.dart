  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Center(child: Text('Vegitable Video Songs',style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),)),
        ),
        body: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Center(child: Text(vegitablevideolist[index].Text,style: const TextStyle(color: Colors.redAccent,fontFamily: "arlrdbd",fontSize: 15),)),
                        )
                      ]
                  ),
                ),
