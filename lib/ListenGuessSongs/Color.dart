  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title: const Center(child: Text('Color',style: TextStyle( color: Colors.black,fontFamily: "arlrdbd"),
            ),
            )
        ),
        body: Center(
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(colorlist[index].Text,style: const TextStyle(color: Colors.black,fontSize: 23.0,fontFamily: "arlrdbd"),),
                        ),
                        const Column(
