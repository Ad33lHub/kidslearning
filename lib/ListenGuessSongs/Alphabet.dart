                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(abcsongs1[index].Text,style: const TextStyle(color: Colors.black,fontSize: 20.0,fontFamily: "arlrdbd"),),
                        ),
                        const Column(
                                  ...
                                  Center(
                                      child: ListTile(
                                        ...
                                        leading: InkWell(
                                          ...
                                          ?(){}
                                                  :(){
                                               controller.previousPage(duration: const Duration(microseconds: 500), curve: Curves.linear);
                                               flutterTts.speak(abcsongs1[index-1].Text);
                                          }:null,
                                          child: const Image(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          const Center(child: Text("Congratulation",style: TextStyle(color: Colors.redAccent,fontFamily: "arlrdbd",fontSize: 38.0),)),
          const Center(child: Text("Your Score is:",style: TextStyle(color: Colors.redAccent,fontFamily: "arlrdbd",fontSize: 25.0,fontWeight: FontWeight.w500),)),
          const SizedBox(height: 50.0,),
          Center(child: Text("${widget.score}",style: const TextStyle(color: Colors.redAccent,fontFamily: "arlrdbd",fontSize: 80.0),))
        ],
      ),
    );
  }
