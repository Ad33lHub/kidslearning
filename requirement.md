Req ID	Module	Requirement Title	Description	Priority	Status
REQ-001	Authentication	Parent Registration	Parent can create account using email and password through Firebase Authentication.	High	Pending
REQ-002	Authentication	Parent Login	Parent can login using registered email and password.	High	Pending
REQ-003	Authentication	Forgot Password	Parent can reset password using Firebase email recovery.	Medium	Pending
REQ-004	Offline System	Offline Mode	After first successful login, the application works fully offline.	High	Pending
REQ-005	Parent Management	Create Child Profile	Parent can create multiple child profiles.	High	Pending
REQ-006	Parent Management	Edit Child Profile	Parent can update child name, avatar, and learning level.	Medium	Pending
REQ-007	Parent Management	Delete Child Profile	Parent can remove child profiles from device storage.	Medium	Pending
REQ-008	Parent Management	Parent PIN Protection	Parent section should be protected with 4-digit PIN.	High	Pending
REQ-009	Dashboard	Parent Dashboard	Parent can view child learning progress and statistics.	High	Pending
REQ-010	Dashboard	Activity History	Parent can see completed activities and quiz attempts.	Medium	Pending
REQ-011	Dashboard	Weak Area Tracking	System identifies weak learning areas based on quiz scores.	Medium	Pending
REQ-012	Dashboard	Learning Time Report	Parent can view total learning time of child.	Medium	Pending
REQ-013	Screen Control	Screen Time Limit	Parent can set daily screen time limit for child.	High	Pending
REQ-014	Screen Control	Usage Tracking	System tracks daily app usage time locally.	Medium	Pending
REQ-015	Screen Control	App Lock After Limit	App locks child learning access after screen limit reached.	Medium	Pending
REQ-016	Learning Module	Alphabets Module	Child can learn A-Z letters with images and sounds.	High	Pending
REQ-017	Learning Module	Alphabet Audio	System plays pronunciation audio for letters and words.	High	Pending
REQ-018	Learning Module	Letter Tracing	Child can trace alphabet letters interactively.	Medium	Pending
REQ-019	Learning Module	Uppercase/Lowercase Matching	Child can match uppercase and lowercase letters.	Medium	Pending
REQ-020	Learning Module	Numbers Module	Child can learn numbers from 1-100.	High	Pending
REQ-021	Learning Module	Counting Activities	Child can perform counting exercises and games.	High	Pending
REQ-022	Learning Module	Number Tracing	Child can trace numbers interactively.	Medium	Pending
REQ-023	Learning Module	Colors Module	Child can identify and learn colors.	High	Pending
REQ-024	Learning Module	Shapes Module	Child can identify and learn shapes.	High	Pending
REQ-025	Learning Module	Color Matching	Child can perform color matching activities.	Medium	Pending
REQ-026	Learning Module	Shape Matching	Child can perform shape matching activities.	Medium	Pending
REQ-027	Learning Module	Fruits & Vegetables Module	Child can learn fruit and vegetable names with visuals.	Medium	Pending
REQ-028	Learning Module	Animals Module	Child can learn animal names and sounds.	Medium	Pending
